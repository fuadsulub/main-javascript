...
// city: "yocale",
// greet: function(){
//   console.log('hi how are doing',this.age)
// }
...
// // Arrays of objects
// let testStudents = ["fuad", "kalid","khadar","casha"];
// let students= [
//   {
//     name:"fuad",
//     age: 25,
...
// meaningfull arrays
const  classStudents =["geedi", "hassan","jamal","hussein",'nour']
for(let i = 0; i < classStudents.length; i++){
  console.log(classStudents[i])
}
let fruits =["Apple", "panana","cherry","mango"]
for(let i = 0; i < fruits.length; i++){
  console.log("I love fruits "+ fruits [i])
}
